    ...
    while lst1 and lst2:
        ...
        if control2:
            ...
            if not lst2:
                break
            control2 = 0
        first1, first2 = lst1[0], lst2[0]
        if first1 < first2:
            control1 = 1
            my_list.append(first1)
        else:
            control2 = 1
            my_list.append(first2)
    return my_list + lst1 + lst2
...
def create_board(rows, columns):
    ...
    for i in range(0, rows):
	    my_list.append(create_row(columns))
    return my_list
...
def print_board(board, max_rows, max_cols):
    ...
    for row in range(0, max_rows):
        ...
        for column in range(0, max_cols):
            row_str += get_piece(board, row, column) + ' '
        print(row_str.strip())
...
def check_win_row(board, max_rows, max_cols, num_connect, row, player):
    ...
    for column in range(0, max_cols - num_connect + 1):
            ...
            for i in range(0, num_connect):
                if get_piece(board, row, column + i) == player:
                    count += 1
...
def check_win_column(board, max_rows, max_cols, num_connect, col, player):
    ...
    for row in range(0, max_rows - num_connect + 1):
            count = 0
            for i in range(0, num_connect):
                if get_piece(board, row + i, col) == player:
                    count += 1
            if count == num_connect:
                return True	       			
    return False
