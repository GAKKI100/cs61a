...
def add_trees(t1, t2):
    ...
    len_b1 = len(branches_of_t1)
    len_b2 = len(branches_of_t2)
    if len_b1 > len_b2:
        additional_branches = [branches_of_t1[i] for i in range(len_b2, len_b1)]
    elif len_b1 < len_b2:
        additional_branches = [branches_of_t2[i] for i in range(len_b1, len_b2)]
    else:
        additional_branches = []
    added_branches = [add_trees(a, b) for a, b in zip(branches_of_t1, branches_of_t2)] + additional_branches
