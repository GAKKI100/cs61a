...
def is_swap(score0, score1):
    ...
    if score0 <= 1 or score1 <= 1:
        ...
        if not score0 % score1:
            return True
        return False
    else:
        if not score1 % score0:
            return True
        return False
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while (score0 < goal) and (score1 < goal):
        if not player:
            time = strategy0(score0, score1)
            score0 += take_turn(time, score1, dice)
        else:
            time = strategy1(score1, score0)
            score1 += take_turn(time, score0, dice)
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if is_swap(new_score, opponent_score) and opponent_score - new_score >= margin:
        return 0
